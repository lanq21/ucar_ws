...
if("TRUE" STREQUAL "TRUE")
  set(simple_navigation_goals_SOURCE_PREFIX /home/lq/ucar_ws/src/simple_navigation_goals)
  set(simple_navigation_goals_DEVEL_PREFIX /home/lq/ucar_ws/src/build/devel)
  ...
  set(simple_navigation_goals_INSTALL_PREFIX /usr/local)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'lq <lq@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'simple_navigation_goals' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lq/ucar_ws/src/simple_navigation_goals/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT simple_navigation_goals_NUM_DUMMY_TARGETS)
      set(simple_navigation_goals_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::simple_navigation_goals::wrapped-linker-option${simple_navigation_goals_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR simple_navigation_goals_NUM_DUMMY_TARGETS "${simple_navigation_goals_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::simple_navigation_goals::wrapped-linker-option${simple_navigation_goals_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND simple_navigation_goals_LIBRARIES "${interface_target_name}")
